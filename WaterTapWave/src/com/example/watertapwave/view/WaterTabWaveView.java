package com.example.watertapwave.view;
 ...
 *
 */
public class WaterTabWaveView extends View {
    ...
    public WaterTabWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
 
    public WaterTabWaveView(Context context) {
        super(context);
        init();
    }
 
    private void init() {
        setWaveInfo(60f, 2f, 2f, 15f, Color.BLACK);
    }
